...
[![NPM version](<https://img.shields.io/npm/v/@lobehub/openapi-typescript.svg?label=npm%20(stable)>)](https://npmjs.org/package/@lobehub/openapi-typescript) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@lobehub/openapi-typescript)
...
```sh
npm install @lobehub/openapi-typescript
```
...
1. Via the `LOBEHUB_LOG` environment variable
...
const client = new Lobehub({
  logger: logger.child({ name: 'Lobehub' }),
...
```ts
import Lobehub from 'npm:@lobehub/openapi-typescript';
...
We are keen for your feedback; please open an [issue](https://www.github.com/lobehub/lobehub-typescript/issues) with questions, bugs, or suggestions.
